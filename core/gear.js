...
const TIERS = [
  ...
  {id:'unique',           name:'Unique',           color:'var(--t-unique)',    statCount:5, uniqueTraits:2, mythicTraits:0, mult:3.32, weight:5,    rollRange:[1.06,1.24], traitValueMult:1.08},
  {id:'legendary',        name:'Legendary',        color:'var(--t-legendary)', statCount:6, uniqueTraits:2, mythicTraits:0, mult:4.30, weight:1.6,  rollRange:[1.10,1.28], traitValueMult:1.18},
